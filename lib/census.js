...
CensusModule.prototype.acsSummaryRequest = function(request, callback) {
    ...
    var request = utils.ajaxRequest(acsURL, function(response) {
        // census "api" sends all sorts of invalid crap back, adding extra safety to recover from it
        try {
            //Turn it into json
            ...
            callback({ error: "Bad response from Census server: " + response });
        }
    });
};
