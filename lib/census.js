...
CensusModule.prototype.aliases = {
    ...
    "age": {
        "api": "acs",
        "variable": { "acs": "B01002_001E" },
        "description": "Median age"
    },
    "median_male_age": {
        "api": "acs",
        "variable": { "acs": "B01002_002E" },
        "description": "Median age by sex (male)"
    },
    "median_female_age": {
        "api": "acs",
        "variable": { "acs": "B01002_003E" },
    ...
    "population_hispanic_origin": {
        "api": "acs",
        "variable": { "acs": "B03001_003E", "sf.1990": "P0080001", "sf.2000": "PCT012H001" },
 ...
 */
var zipCodeLookupTable = {};
utils.ajaxRequest('https://s3.amazonaws.com/citysdk/zipcode-to-coordinates.json', function(response) {
    var returnValue = {
        "lat": null,
        "lng": null
    };
    ...
    try {
        ...
        if("10001" in response) {
            zipCodeLookupTable = response;
        }        
    } catch (e) {
        console.error('Failed to prefetch zipcode lookup table, this will result in slower processing');
    }
});
...
CensusModule.prototype.zipToLatLng = function(zip, callback) {
    if (zipCodeLookupTable[zip]) {
        // logic that uses a lookup table for the zipcode to lat,lng conversion
    } else {
